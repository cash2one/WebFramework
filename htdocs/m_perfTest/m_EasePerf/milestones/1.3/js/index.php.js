...
function load_idx_info() {
    ...
    $.getJSON("./php/readIdxDb.php", function(data) {
        ...
        $("#user_list").html("");
        var usernames = getSortedKeys(g_idxObj["userinfo"]);
        for(var index in usernames){
            $("#user_list").append("<option>" + usernames[index] + "</option>");
        }
...
function load_product() {
    ...
    var products = getSortedKeys(userdata[currentuser]);
    for (var index in products) {
        $("#product_list").append("<option>" + products[index] + "</option>");
    }
    //load machine infos
...
function load_type_cube() {
    ...
    if(isuserinfo){
        var userdata = g_idxObj["userinfo"];
        var currentuser = g_currentUser; //$("#user_list").val();
        var type_cubedatas = getSortedKeys(userdata[currentuser][productname]);
        for (var index in type_cubedatas) {
            var type_cube = type_cubedatas[index];
