...
function drawMachineTable(items){
    ...
    $("#system").append("<thead></theah>").children().last().append("<tr></tr>").children().last().append("<th>机器名称</th>").append("<th>内存(M)</th>").append("<th>CPU(%)</th>").append("<th>LOAD</th>").append("<th>网络(KB/s)</th>").append("<th>磁盘读写(hit/s)</th>");
	...
	var mem_used = getValue(itemvalue["mem"],"mem_used","avg");
        ...
        var network = escapeHtml( "r: " + getValue(itemvalue["network"],"network_receive","avg") + "\ts: " + getValue(itemvalue["network"],"network_send","avg") );
        var disk = escapeHtml( "r: " + getValue(itemvalue["disk"],"disk_read","avg") + "\tw: " + getValue(itemvalue["disk"],"disk_write","avg") ); 
        $("#system tbody").first().append("<tr></tr>").children().last().append("<td>" + itemname + "</td>").append("<td>" + mem + "</td>").append("<td>" + cpu + "</td>").append("<td>" + load + "</td>").append("<td>" + network + "</td>").append("<td>" + disk + "</td>");
    }
