$("a.show_var").click(function(e) {
    if ($(this).html() == "[+]"){
        $("div#section_var").show();
        $(this).html("[-]");
    }
    else{
        $("div#section_var").hide();
        $(this).html("[+]");
    }
    e.preventDefault();
});

$("a.show_step").click(function(e) {
    if ($(this).html() == "[+]"){
        $("div#section_step").show();
        $(this).html("[-]");
    }
    else{
        $("div#section_step").hide();
        $(this).html("[+]");
    }
    e.preventDefault();
});

$("a.show_collect").click(function(e) {
    if ($(this).html() == "[+]"){
        $("div#section_collect").show();
        $(this).html("[-]");
    }
    else{
        $("div#section_collect").hide();
        $(this).html("[+]");
    }
    e.preventDefault();
});
